...
const ProjectOverlay = ({ name, bullets, skills, body, image, link, github, onClose, ref }) => {

    return (
        <div ref={ref} className="flex flex-col bg-white gap-4 p-10 mx-10 my-10 h-full rounded-2xl scrollbar-hide overflow-auto">
