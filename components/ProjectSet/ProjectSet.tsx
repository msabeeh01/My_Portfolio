...
const ProjectSet = () => {
  return (
    <div className="flex flex-col">
      {/* title spaces */}
      <div
        className="flex flex-col md:flex-row justify-between items-center my-14"
        data-aos="fade-up"
      >
      ...
      <div className="flex flex-wrap md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        <ProjectBento
          name={"Whisker Wizard"}
          description={
            "Powerful Web and Mobile Application for meticulous pet owners"
          }
          skills={[
            "Flutter",
            "React",
          ...
          body={
            "Whisker Wizard is a powerful web application designed to help pet owners manage their furry friends' health and well-being with ease. Keep your pets healthy and happy by tracking their health records, scheduling care tasks, and monitoring their progress over time."
          }
          bullets={[
            "Engineered an application using TypeScript and Dart, with a frontend built on NextJS and a mobile interface crafted with React Native and Flutter.",
        ...
        <ProjectBento
          name={"Driveroo"}
          description={
            "Mobile application that seeks to revolutionize the process of scheduling driving lessons"
          }
          body={
            "Driveroo is a mobile application that seeks to revolutionize the process of scheduling driving lessons. It is designed to provide a seamless and efficient experience for both driving instructors and students."
          }
          skills={[
            "React Native",
            "NodeJS",
        ...
        <ProjectBento
          name={"Experiments"}
          description={
            "A repo for experimenting and learning new things via half baked projects"
          }
          skills={["Alot"]}
